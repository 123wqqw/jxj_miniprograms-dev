				...
				<view class="homework-content">
					<view class="homework-info">
						<view class="info-item">
							<image src="/static/images/students/class.png" class="info-icon"></image>
							<text class="info-text">{{ homework.subject }}</text>
						</view>
						<view class="info-item">
							<image src="/static/images/students/read.png" class="info-icon"></image>
							<text class="info-text">{{ homework.duration }}分钟</text>
						</view>
						<view class="info-item">
							<image src="/static/images/students/rank.png" class="info-icon"></image>
					...
					<view class="homework-footer">
						...
						<view class="homework-action">
							<view class="action-btn" :class="homework.status" @click.stop="handleHomework(homework)">
...
export default {
	...
	computed: {
		filteredHomeworkList() {
			...
			return this.homeworkList.filter(homework => homework.status === this.activeFilter)
		}
	},
	onLoad() {
