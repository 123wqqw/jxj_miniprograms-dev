	...
	<view class="student-home">
		...
		<view class="user-header">
			<view class="user-info">
				<view class="avatar">
					<image :src="studentInfo.avatar || '/static/images/students/user.png'" mode="aspectFill" class="avatar-img"></image>
				</view>
		...
		<view class="welcome-card">
			<view class="welcome-content">
				...
				<view class="mascot">
					<image src="/static/images/students/logo.png" mode="aspectFit" class="mascot-img"></image>
				</view>
			</view>
		</view>
		...
		<!-- 文字提示 -->
		<view class="text-tip">
			<view class="text-tip-text">呼叫{{ studentInfo.name || '学生姓名' }}！无论什么原因暂停，这里永远是你的加油站。今天先来活动10分钟，找回感觉就好！</view>
		</view>
		...
		<view class="function-grid">
			<view class="grid-item-group">
				<view class="grid-item" @click="goToGym"
					...
					<image src="/static/images/students/exercise.png" class="item-icon"></image>
				...
				<view class="grid-item" @click="goToHomework"
					...
					<image src="/static/images/students/homework.png" class="item-icon"></image>
			...
			<view class="grid-item-group" style="margin-top: 40rpx;">
				<view class="card-item leaderboard-card" @click="goToLeaderboard">
					<image src="/static/images/students/banner.png" class="card-bg-image"></image>
...
.welcome-card {
	...
	border-radius: 24rpx;
	z-index: 7;
	background-image: url('/static/images/students/banner.png');
