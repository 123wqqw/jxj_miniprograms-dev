		...
		<view class="modal-content" @click.stop>
			...
			<view class="user-info-section">
				<view class="user-info">
					<view class="avatar">
						<image :src="userInfo.avatar || '/static/images/students/user.png'" mode="aspectFill" class="avatar-img"></image>
					</view>
				...
				<view class="menu-item" @click="toggleAccountSecurity">
					<view class="menu-item-content">
						...
						<view class="arrow-icon" :class="{ 'expanded': accountSecurityExpanded }">
							<image src="/static/images/students/arrow-right.png" class="arrow-img"></image>
						</view>
					</view>
