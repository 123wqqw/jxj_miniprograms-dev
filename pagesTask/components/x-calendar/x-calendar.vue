			...
			init() {
				...
				if(this.mode == 'date'){
					...
					if(this.defaultRange.length==2){
						let startDate = this.defaultRange[0];
						let startTime = this.initDate(startDate);
						this.startYear = startTime.year;
						this.startMonth = startTime.month;
						this.startDay = startTime.day;
						this.startDate = `${this.startYear}-${this.startMonthh}-${this.startDay}`;
						let endDate = this.defaultRange[1];
						let endTime = this.initDate(endDate);
