  ...
  <view class="student-home">
    ...
    <view class="user-header">
      <view class="user-info">
        <view class="avatar">
          <image
            :src="studentInfo.avatar || '/static/images/img/default.png'"
            mode="aspectFill"
            class="avatar-img"
          ></image>
        </view>
      ...
      <view class="header-actions">
        <view class="action-btn" @click="switchUser">
          <image
            src="/static/images/img/change.png"
            class="action-icon"
          ></image>
          <text class="action-text">切换用户</text>
        </view>
        <view class="action-btn" @click="goToProfile">
          <image src="/static/images/img/user.png" class="action-icon"></image>
    ...
    <view class="function-grid">
      <view class="grid-item-group">
        <view class="grid-item exercise-bg" @click="goToGym">
          <image
            src="/static/images/img/exercise.png"
            class="bg-image"
            mode="aspectFill"
          ></image>
        </view>
        ...
        <view class="grid-item homework-bg" @click="goToHomework">
          <image
            src="/static/images/img/homework.png"
            class="bg-image"
            mode="aspectFill"
          ></image>
        </view>
      ...
      <view class="grid-item-group" style="margin-top: 40rpx">
        ...
        <view class="card-item records-card" @click="goToRecords">
          <image
            src="/static/images/img/record.png"
            class="card-bg-image"
          ></image>
