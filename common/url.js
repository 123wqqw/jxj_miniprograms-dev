const URL = {
  ...
  // 11111 接口已对接
	...
	// 获取所有AI锻炼记录列表 1111111
	jxjRecordList:"/xty-task/app-api/clock/v2/getRecordInfos",
	// 获取AI锻炼记录详情  1111111111
	jxjRecordDetail:"/xty-task/app-api/clock/v1/getDetailRecordInfo",
};
