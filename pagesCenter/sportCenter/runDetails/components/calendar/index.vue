<template>
	<view class="u-calendar">
		<view class="u-calendar__action u-flex u-row-between">
			...
			<u-icon name="arrow-left" color="#979797" @click="changeMonthHandler(0)" size="16rpx"
				:custom-style="{'border': '1px solid #E0E0E0','padding':'16rpx','borderRadius':'50%'}">
			</u-icon>
			<view class="u-calendar__action__text">{{ showTitle }}</view>
			<u-icon name="arrow-right" color="#979797" @click="changeMonthHandler(1)" size="16rpx"
				:custom-style="{'border': '1px solid #E0E0E0','padding':'16rpx','borderRadius':'50%'}">
			</u-icon>
			<!-- <view class="u-calendar__action__icon">
		...
		<view class="u-calendar__content">
			...
			<view class="u-calendar__content__item" :class="{
				...
				<view class="u-calendar__content__item__inner"
					:style="{color: getColor(index,2),backgroundColor: getColor(index,1)}">
					<view>{{ index + 1 }}</view>
				</view>
